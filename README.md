...
```powershell
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\01_model_construction\build_ec_iFX1172.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\01_model_construction\export_ec_iFX1172_formats_and_article.py
```
...
```powershell
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\02_validation_memote_curation\run_memote_compare.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\02_validation_memote_curation\summarize_memote_comparison.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\02_validation_memote_curation\enhance_ecmodel_memote_annotations.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\02_validation_memote_curation\summarize_memote_enhancement.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\02_validation_memote_curation\curate_ecmodel_memote_structural_issues.py
```
...
```powershell
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\03_analysis_prediction\run_ec_iFX1172_advanced_analysis.py
D:\python\python.exe ecGEM_construction\code_package_iFX1172_to_eciFX1172\03_analysis_prediction\run_ec_iFX1172_advanced_analysis_v2.py
```
